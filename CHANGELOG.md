...
## Fork Changes (ougonnokishi/claude-code-action@beta)
...
- **Updated Base Action**: Uses `ougonnokishi/claude-code-base-action@beta` which includes OAuth credential handling
